...
describe('FilesService', () => {
  ...
  describe('getPoster', () => {
    ...
    it('should throw NotFoundException for non-existent poster', async () => {
      ...
      await expect(service.getPoster('nonexistent.jpg')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('getStill', () => {
    ...
    it('should throw NotFoundException for non-existent still', async () => {
      ...
      await expect(service.getStill('nonexistent.jpg')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('getVideo', () => {
    ...
    it('should throw NotFoundException for non-existent video', async () => {
      ...
      await expect(service.getVideo('nonexistent.mp4')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
